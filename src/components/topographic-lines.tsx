export function TopographicLines() {
  return (
    <div className="absolute inset-0 w-full h-full pointer-events-none opacity-[0.03] overflow-hidden flex items-center justify-center mix-blend-multiply">
      <svg viewBox="0 0 1000 1000" className="w-[150%] md:w-full h-auto object-cover" fill="none" xmlns="http://www.w3.org/2000/svg">
        <g stroke="currentColor" strokeWidth="1" strokeOpacity="0.5">
          ...
          <text x="510" y="303" fontSize="10" fontFamily="monospace" fill="currentColor" letterSpacing="0.2em">PEAK_3200M</text>
        </g>
      </svg>
    </div>
  );
